      ...
      <section id="testimonials">
        <Layout>
          <div className="flex flex-col text-center w-full">
            ...
            <Slider {...settings} className="h-[18rem] px-6 w-[95vw] mx-auto">
              {testimonials.map((testimonial) => (
                <div key={testimonial.id} className="space-y-2 h-[18rem]">
                  <img
                    src={testimonial.photo}
                    alt={testimonial.name}
                    className="h-16 mx-auto rounded-full -mb-8"
                    style={{
                      border: "6px solid rgba(33, 123, 244, 0.2)",
                    }}
                  />
                  <div
                    className="flex flex-col text-left px-4 py-6 rounded-lg mx-2"
